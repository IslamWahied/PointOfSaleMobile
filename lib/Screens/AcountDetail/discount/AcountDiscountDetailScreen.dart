...
class AcountDiscountDetailScreen extends StatelessWidget {
  String selectedIcon;
  String heroTag;
  String titleName;
  int typeId;

  AcountDiscountDetailScreen({Key key, this.selectedIcon, this.heroTag, this.titleName,this.typeId})
      : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const SizedBox(height : 10),
                         ...
                         (cubit.list.where((element) => convertStringToDateTime(element.EntryDate).day == DateTime.now().day &&
                             convertStringToDateTime(element.EntryDate).month ==DateTime.now().month && convertStringToDateTime(element.EntryDate).year == DateTime.now().year &&
                             element.Discount > 0).toList().isNotEmpty && cubit.isShowTodayAccountOnly) ||
                             (cubit.list.where((element) => element.Discount > 0).toList().isNotEmpty &&!cubit.isShowTodayAccountOnly )?
                        ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if(cubit.isShowTodayAccountOnly){
                                model = cubit.list.where((element) => convertStringToDateTime(element.EntryDate).day == DateTime.now().day && convertStringToDateTime(element.EntryDate).month ==DateTime.now().month && convertStringToDateTime(element.EntryDate).year == DateTime.now().year && element.Discount > 0).toList()[index];
                              }
                              else{
                                model = cubit.list.where((element) => element.Discount > 0).toList()[index];
                              }
                              ...
                              return Material(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle:Text(intl.DateFormat('yyyy-MM-dd\nhh:mm a').format(convertStringToDateTime(model.EntryDate))),

                                  trailing:     Text("-\$ ${model.Discount}",
                                      style: const TextStyle(
                                          fontSize: 18,
                            ...
                            itemCount: cubit.isShowTodayAccountOnly?  cubit.list.where((element) => convertStringToDateTime(element.EntryDate).day == DateTime.now().day && convertStringToDateTime(element.EntryDate).month ==DateTime.now().month && convertStringToDateTime(element.EntryDate).year == DateTime.now().year && element.Discount > 0).toList().length:cubit.list.where((element) => element.Discount > 0).toList().length
