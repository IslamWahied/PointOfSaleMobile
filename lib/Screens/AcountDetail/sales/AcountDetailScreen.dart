...
class AcountSalesDetailScreen extends StatelessWidget {
  String selectedIcon;
  String heroTag;
  String titleName;
  int typeId;

  AcountSalesDetailScreen(
      {Key key, this.selectedIcon, this.heroTag, this.titleName, this.typeId})
      : super(key: key);
          ...
          appBar: AppBar(
            title: Row(
              ...
              children: [
                ...
                Text(titleName,
                    style:
                        const TextStyle(fontSize: 25, color: AppColors.black)),
              ],
            ),
            centerTitle: true,
            elevation: 0,
                  ...
                  onSelectionChanged:
                    ...
                    if (args.value is PickerDateRange) {
                      ...
                      if (cubit.endDate != null) {
                        cubit.startDate = DateTime(cubit.startDate.year,
                            cubit.startDate.month, cubit.startDate.day - 1);
                        cubit.endDate = DateTime(cubit.endDate.year,
                            cubit.endDate.month, cubit.endDate.day + 1);
                      }
                  ...
                  children: [
                    Directionality(
                      ...
                      child: Padding(
                        ...
                        //       clearButton:
                        //           cubit.empCode != null && cubit.empCode != 0
                        //               ? InkWell(
                        //                   onTap: () async {
                        //                     await cubit.clearUserButton(
                        //                         typeId: typeId);
                        //                   },
                        //                   child: const Icon(
                        //                     Icons.close,
                        ...
                        //         cubit.empCode = cubit.listEmployeeModel
                        //                 .where((element) =>
                        //                     element.EmployeeCode != 0 &&
                        //                     element.EmployeeName.toString()
                        //                             .toLowerCase()
                        //                             .trim() ==
                        //                         value
                        //                             .toString()
                      ...
                      children: <Widget>[
                        ...
                        convertStringToDateTime(
                            ...
                            convertStringToDateTime(
                                ...
                                .year ==
                                DateTime.now().year)
                            .toList().isNotEmpty && cubit.isShowTodayAccountOnly) ||
                        ...
                        ListView.separated(
                            ...
                            itemCount: cubit.isShowTodayAccountOnly
                                ? cubit.list
                                    .where((element) =>
                                        convertStringToDateTime(
                                                    element.EntryDate)
                                    ...
                                    .toList()
                                    .length
                                : cubit.list.length) :Text("لا يوجد نتائج",style: TextStyle(fontSize: 16,color: Colors.grey[700],fontWeight: FontWeight.w200),)
                      ],
                    ),
                  )
              ],
